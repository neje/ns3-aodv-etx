...
public:
  ...
  void SetEtxMetrix (uint32_t s) { m_etxMetrix = s; }
  uint32_t GetEtxMetrix () const { return m_etxMetrix; }
...
public:
  ...
  void SetSourceAddress (Ipv4Address a) { m_sourceAddr = a; }
  Ipv4Address GetSourceAddress () const { return m_sourceAddr; }
...
private:
  ...
  Ipv4Address    m_sourceAddr;     ///< Source IP Address
